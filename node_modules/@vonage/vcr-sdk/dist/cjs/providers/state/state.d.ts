...
export declare class State implements IState {
    /**
     * The namespace for the state object.
     */
    namespace: string;
    /**
     * The URL of the state object.
     */
    private url;
    /**
     * The bridge for the state object.
     */
    private bridge;
    /**
     * The session for the state object.
     */
    private session;
    /**
     ...
     */
    constructor(session: ISession, namespace?: string);
    /**
     ...
     * @returns {Promise<string>} A promise that resolves to "1" if the key was deleted, or "0" if the key did not exist.
     */
    mapDelete(htable: string, keys: string[]): Promise<string>;
    /**
     ...
     */
    mapExists(htable: string, key: string): Promise<string>;
    /**
     ...
     */
    mapGetAll(htable: string): Promise<Record<string, string>>;
    /**
     ...
     */
    mapGetMultiple(htable: string, keys: string[]): Promise<string[]>;
    /**
     ...
     */
    mapGetValues(htable: string): Promise<string[]>;
    /**
     ...
     */
    mapGetValue(htable: string, key: string): Promise<string>;
    /**
     ...
     */
    mapSet(htable: string, keyValuePairs: Record<string, string>): Promise<string>;
    /**
     ...
     */
    mapIncrement(htable: string, key: string, value: number): Promise<string>;
    /**
     ...
     */
    mapLength(htable: string): Promise<string>;
    mapScan(htable: string, cursor: string, pattern: string, count: number): Promise<[string, string[]]>;
    /**
