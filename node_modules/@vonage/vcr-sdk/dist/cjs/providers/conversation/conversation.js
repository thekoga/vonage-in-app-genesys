        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (events != null) {
                for (let i = 0; i < events.length; i++) {
                    filters.push(new filter_js_1.Filter('type', 'contains', [events[i]]));
                }
            }
            const rp = new requestParams_js_1.RequestParams();
            rp.method = requestVerb_js_1.REQUEST_VERB.POST;
            rp.data = new conversationPayloadWithCallback_js_1.ConversationPayloadWithCallback(this.session.wrapCallback(callback, filters), this.session.config.apiApplicationId);
