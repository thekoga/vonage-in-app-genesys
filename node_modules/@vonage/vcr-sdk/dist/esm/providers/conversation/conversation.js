                    ...
                    case 0:
                        ...
                        if (events != null) {
                            for (i = 0; i < events.length; i++) {
                                filters.push(new Filter('type', 'contains', [events[i]]));
                            }
                        }
                        rp = new RequestParams();
                        rp.method = REQUEST_VERB.POST;
                        rp.data = new ConversationPayloadWithCallback(this.session.wrapCallback(callback, filters), this.session.config.apiApplicationId);
