...
import { VonageAPIActions } from "./vonageAPIActions.js";
import { InvokePayload } from "./contracts/invokePayload.js";
import { REQUEST_VERB } from "../../request/enums/requestVerb.js";
import { RequestParams } from "../../request/contracts/requestParams.js";
var VonageAPI = /** @class */ (function () {
    function VonageAPI(session) {
        this.provider = "vonage-api";
        this.session = session;
    }
    VonageAPI.prototype.invoke = function (url, method, body) {
        return __awaiter(this, void 0, void 0, function () {
            var payload, requestParams;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        payload = new InvokePayload(url, method, body);
                        ...
                        requestParams.url = this.session.config.getExecutionUrl(this.provider, VonageAPIActions.INVOKE);
